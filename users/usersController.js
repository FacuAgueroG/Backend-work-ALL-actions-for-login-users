...
const register = async (req, res, next) => {
    ...
    let image = ''; //Es posible crear perfil sin foto de perfil
    if(req.file == undefined){
        
        image = `${public_url}/sinFotoPerfil`;
    }
    else{
        image = `${public_url}/${req.file.filename}`;
    }
    ...
    const user = {
        // id: cleanBody.body.id, //el id lo asigna la bbdd
        name: cleanBody.name,
...
const forgot = async (req, res, next) => {
    ...
    console.log("respuesta de la BBDD", dbResponse);
